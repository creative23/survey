...
$sql=$dbo->prepare("insert into poll_answer365(email,qst_id,opt,correct, mark) values('email',$qst_id,'$opt','$correct','$mark')");
...
$count=$dbo->prepare("select * from poll_d365 where qst_id=$qst_id  ");
if($count->execute()){
